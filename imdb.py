...
def load_args():
    ...
    parser.add_argument('--convergence_epoch', type=int, default=100, help="number of epochs for warmup")  # adjust
...
def main():
    ...
    model = MSHGTModel(num_nodes=num_nodes, in_dim=in_dim, hidden_dim=args.hidden_dim, out_dim=num_classes,
